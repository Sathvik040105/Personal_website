...
with body:
    ...
    with col1:
        st.image("1722592429814.jpeg", width=100%)  # Adjust width percentage as needed
    with col2:
        st.image("1722592748119.jpeg", width=100%)  # Adjust width percentage as needed
    with col3:
        st.image("1722592715149.jpeg", width=100%)  # Adjust width percentage as needed   
